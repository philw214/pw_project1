...
# get rid of Card.destroy_all, redundanct
...
geography.cards.create([
  {question:"Redwoods, the world's tallest trees, are found in which state?", answer:"California"},
  {question:"Where does the Missouri River begin?", answer:"Montana"},
  ...
  {question:"What other European country had French as an official language for over 600 years?", answer:"England"},
